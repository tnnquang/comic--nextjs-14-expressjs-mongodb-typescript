...
import { BASE_URL_API, GET_COMIC_BY_FILTER, GET_COMIC_COMMING_SOON, fetchOrigin } from "@/common/constant";

export default async function CommingSoonComponent() {
  const res = await fetch(`${BASE_URL_API}${GET_COMIC_COMMING_SOON}`, {
    method: "POST",
    headers: {
